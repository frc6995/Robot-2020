...
/**
 * The Preferences class provides a convenient place for us to hold robot-wide
 * numerical or boolean preferences. This class should not be used for any other
 * purpose. All preferences should be declared globally (i.e. public static). Do
...
public final class RobotPreferences {
    ...
    public static final NomadDoublePreference climberKpDown = new NomadDoublePreference("Climber Kp Up", 0.06);
    public static final NomadDoublePreference climberKiDown = new NomadDoublePreference("Climber Ki Up", 0.0001);
    public static final NomadDoublePreference climberKdDown = new NomadDoublePreference("Climber Kd Up", 8);
    ...
    public static final NomadDoublePreference visionKpHorizontal = new NomadDoublePreference("Vision Horizontal kP",
            0.04f);
    public static final NomadDoublePreference visionKpVertical = new NomadDoublePreference("Vision Vertical kP", 0.04f);
}
